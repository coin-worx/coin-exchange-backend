    ...
    public abstract class AbstractConfiguration : AbstractTransactionalDbProviderSpringContextTests
    {
        protected override string[] ConfigLocations
        {
            get
            {
                return new[]
                    {
                        "assembly://CoinExchange.IdentityAccess.Infrastructure.Persistence/CoinExchange.IdentityAccess.Infrastructure.Persistence/InfrastructurePersistenceConfig.xml",
                    };
            }
        }
    }
